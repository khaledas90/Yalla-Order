...
const SuccessPass = lazy(() => import("./components/SuccessPass/SuccessPassWord"));
const AboutUs = lazy(() => import("./components/AboutUs/AboutUs"));
const ContactUs = lazy(() => import("./components/ContactUs/ContactUs"));
const ContactUsDone = lazy(() => import("./components/ContactUs/ContactUsDone"));
...
const ShowAllClinics = lazy(() => import("./pages/ShowAllClinics"));
...
const TrackedOrderItem = lazy(() => import("./components/TrackOrders/TrackedOrderItem"));
const RestaurantCategory = lazy(() => import("./components/FavCuisines/RestaurantCategory"));
const ProtectedRoute = lazy(() => import("./components/ProtectedRoute/ProtectedRoute"));
const MyReservations = lazy(() => import("./components/Profile/MyReservations"));
                            ...
                            <Suspense fallback={<Loader />}>
                                <TransitionWrapper>
                                    <Routes>
                                        ...
                                        <Route path="/restaurants/:id/menu/orderPage" element={<ProtectedRoute><OrderPage /></ProtectedRoute>} />
                                        <Route path="/restaurants/:id/menu/orderPage/:orderId" element={<ProtectedRoute><OrderSummary /></ProtectedRoute>} />
                                        <Route path="/categories/:id" element={<ProtectedRoute><RestaurantCategory /></ProtectedRoute>} />
                                        <Route path="/trackOrders" element={<ProtectedRoute><TrackOrders /></ProtectedRoute>} />
                                        <Route path="/trackOrders/:id" element={<ProtectedRoute><TrackedOrderItem /></ProtectedRoute>} />
                                        ...
                                        <Route path="/LoginAPartner" element={<ProtectedRoute><LoginAPartner /></ProtectedRoute>} />
