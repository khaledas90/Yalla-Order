...
const apiClient = axios.create({
  ...
  //   baseURL : "https://web-allsafeeg.com/FoodC/public/api",
  //   headers : {
  //     'Content-Type' : 'application/json',
  //   }
  // });
...
export const fetchRestaurantById = async (id) => {
    try {
      const response = await apiClient.get(`/places/restaurantes/show/details/${id}`);
      return response.data;
    } catch (error) {
  ...
  export const fetchMenuItems = async (restaurantId, categoryId) => {
    try {
      const response = await apiClient.get(`/places/restaurantes/menue/listbyfilter/${restaurantId}/${categoryId}`);
      return response.data;
    } catch (error) {
      console.error(`Error fetching menu items for restaurant ${restaurantId} and category ${categoryId}:`, error);
      throw error;
    }
  };
...
export const fetchAllMenuItems = async (restaurantId) => {
  try {
    const response = await apiClient.get(`/places/restaurantes/menue/list/${restaurantId}`);
    return response.data;
  } catch (error) {
...
// Fetch order details by restaurant ID and product ID
  export const fetchOrderDetails = async (restaurantId, productId) => {
    try {
      const response = await apiClient.get(`/places/restaurantes/menue/show/details/choose/order/${restaurantId}/${productId}`);
      return response.data;
    } catch (error) {
      console.error(`Error fetching order details for restaurant ${restaurantId} and product ${productId}:`, error);
      throw error;
    }
  };
...
export const addToCart = async ({ qty, product_id, place_id, size_id, item, sauce }) => {
  try {
...
export const confirmOrder = async (orderId, { special_request, delivery_method, pay_method }) => {
  try {
    const response = await apiClient.post(`/places/restaurantes/order/confirm/${orderId}`, {
      special_request,
      delivery_method,
      pay_method,
    });
...
export const deleteOrder = async (orderId) => {
  try {
    const response = await apiClient.get(`/places/restaurantes/order/delete/${orderId}`);
    return response.data;
  } catch (error) {
...
export const addItemToFavorites = async (productId) => {
  try {
    const response = await apiClient.post(`/places/restaurantes/menue/add/favproduct/${productId}`);
    return response.data;
  } catch (error) {
...
//https://insta-order-site.web-allsafeeg.com/api
//https://web-allsafeeg.com/FoodC/public/api/places/restaurantes/order/summary/269
// Fetch order summary by order ID
export const fetchOrderSummary = async (orderId) => {
  try {
    const response = await apiClient.get(`/places/restaurantes/order/summary/${orderId}`);
    return response.data;
  } catch (error) {
...
export const trackOrder = async (orderId) => {
  try {
    const response = await apiClient.get(`/places/restaurantes/order/trackorder/${orderId}`);
    return response.data;
  } catch (error) {
...
export const fetchOrdersList = async () => {
  try {
    const response = await apiClient.get(`/places/restaurantes/order/myorder?type=order`);
    return response.data;
  } catch (error) {
...
export const fetchBagItems = async () => {
  try {
    const response = await apiClient.get(`/places/restaurantes/order/show?type=order`);
    return response.data;
  } catch (error) {
...
export const fetchProductsByCategory = async (categoryId) => {
  try {
    const response = await apiClient.get(`/category/show/bycategory/${categoryId}`);
    return response.data;
  } catch (error) {
...
export const searchRestaurants = async (name, type) => {
  try {
    const response = await apiClient.post('/places/search/name', { name, type });
    return response.data;
  } catch (error) {
