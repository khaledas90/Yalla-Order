...
function Bag({bagItems,setBagItems,loadingBagItems,setLoadingBagItems,bagItemsError,setBagItemsError}) {
...
console.log(bagItems)
  ...
  return (
   ...
   <p  className="bagHeader">My Bag</p>
    {bagItems?.map((order => 
      <>
      <p key={order['Order Id']} className="bagHeader">My order</p>
      <div className="bag-content">
        <p className="restaurant-name">{order['Resturant Name']} - <span>{order['Resturant Address']}</span></p>
        ...
        <button onClick={() => handleNavToOrderSummary(order['Resturant id'],order['Order Id'],order['Resturant Name'],order['Product Name'])} className="checkBtn">Check Order</button>
        <button onClick={() => handleDeleteOrder(order['Order Id'])} className="delBtn"><DeleteOutlineOutlinedIcon/></button>
        </div>
