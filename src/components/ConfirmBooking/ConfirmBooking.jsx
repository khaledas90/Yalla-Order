...
const ConfirmBooking = () => {
  ...
  useEffect(() => {
    ...
    if (idReservation) {
      apiAuthenticate
        .get(`places/clinic/doctor/summary/reservation/${idReservation}`)
        .then((response) => {
          ...
          <div className="reservation-summary p-2 my-5">
            ...
            <div className="info-row">
              ...
              <div className="patient-data p-2 my-4">
                ...
                <div className="info-row text-black-50">
                  <span>
                    {dataReservation?.["patient name"] || "-----------------"}
                  </span>
                  <span>
                    {dataReservation?.["patient phone"] || "01************"}
                  </span>
                </div>
                <div className="info-row bg-body-secondary p-2">
                  <span>Gender</span>
                ...
                <div className="info-row text-black-50">
                  <span>
                    {dataReservation?.["patient gender"] || "---------"}
                  </span>
              ...
              <div className="reservation-details my-3">
                ...
                <div className="info-row text-black-50">
                  <span>
                    {dataReservation?.["patient day_booking"] || "00/00/0000"}
                  </span>
                  <span>
                    {dataReservation?.patienttime_booking || "00:00 "}
                  </span>
                </div>
              </div>
              <div className="payment-summary p-2">
                ...
                <div className="info-row p-2">
                  ...
                  <span>
                    {dataReservation?.totalprice || "reservation.fees"}
                  </span>
                </div>
              </div>
              <div className="d-flex justify-content-center">
                <button
                  ref={observe}
                  className={`confirm-button rounded-pill ${
                    isClicked ? "disabledBtn" : ""
                  }`}
              ...
              <div className="iframe_container">
                <div
                  className={`overlayIframe ${
                    url ? "activeOverlayIframe" : ""
                  }`}
                ></div>
                {url && (
                  <iframe
